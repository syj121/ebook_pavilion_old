...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { menu_id: @permission.menu_id, name: @permission.name, usable: @permission.usable } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { menu_id: @permission.menu_id, name: @permission.name, usable: @permission.usable } }
